...
async def run(playwright: Playwright) -> None:
    ...
    await page.get_by_label("Mostrar", exact=False).select_option("50")

    # Define o caminho para salvar o arquivo .zip
    download_path = "C:/Users/Rogerio/Documents/playwright/downloads/finalizadas_2024-07.zip"  # Caminho onde o arquivo zip será salvo
    extract_path = "C:/Users/Rogerio/Documents/playwright/dados/"  # Pasta para onde os arquivos serão extraídos

    # Garante que o diretório de extração exista
    os.makedirs(extract_path, exist_ok=True)
    
    async with page.expect_download(timeout=1300000) as download_info:
        async with page.expect_popup() as page1_info:
            await page.get_by_title("Download 'finalizadas_2024-07").click(timeout=1300000)
